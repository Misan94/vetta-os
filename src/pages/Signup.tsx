        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white z-10">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 opacity-80">
              <div className="text-lg font-semibold drop-shadow-md">Influencers</div>
              <div className="text-lg font-semibold drop-shadow-md">Brands</div>
              <div className="text-lg font-semibold drop-shadow-md">Creators</div>
